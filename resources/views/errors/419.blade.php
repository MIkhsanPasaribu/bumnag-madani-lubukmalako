...
<head>
    ...
    <title>419 - Sesi Kedaluwarsa | BUMNag Madani</title>
    <style>
...
<body>
    <div class="container">
        ...
        <svg class="icon" viewBox="0 0 120 120" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <circle cx="60" cy="55" r="22" stroke="#f59e0b" stroke-width="2.5" fill="none"/>
            <path d="M60 43v14" stroke="#f59e0b" stroke-width="3" stroke-linecap="round"/>
            <path d="M60 55l10 10" stroke="#f59e0b" stroke-width="3" stroke-linecap="round"/>
            <path d="M52 82h16" stroke="#374151" stroke-width="2" stroke-linecap="round"/>
            <path d="M48 88h24" stroke="#374151" stroke-width="2" stroke-linecap="round" stroke-dasharray="3 3"/>
        </svg>
