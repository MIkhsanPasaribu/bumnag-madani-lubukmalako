    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
        <form action="{{ route('admin.kategori-berita.update', $kategoriBerita) }}" method="POST" class="space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                {{-- Nama Kategori --}}
                <div class="space-y-2" x-data="{ count: {{ mb_strlen(old('nama', $kategoriBerita->nama ?? '')) }} }">
            ...
            {{-- Deskripsi --}}
            <div class="space-y-2" x-data="{ count: {{ mb_strlen(old('deskripsi', $kategoriBerita->deskripsi ?? '')) }} }">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                {{-- Icon --}}
                <div class="space-y-2" x-data="{ count: {{ mb_strlen(old('icon', $kategoriBerita->icon ?? '')) }} }">
