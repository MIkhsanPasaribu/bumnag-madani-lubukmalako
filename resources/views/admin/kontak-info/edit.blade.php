    ...
    <form action="{{ route('admin.kontak-info.update') }}" method="POST">
        ...
        <div class="space-y-6">
            ...
            <div class="bg-white rounded-xl border border-gray-200 shadow-sm overflow-hidden">
                ...
                <div class="p-5 space-y-4">
                    <div class="grid sm:grid-cols-2 gap-4">
                        <div x-data="{ count: {{ mb_strlen(old('telepon', $kontak->telepon ?? '')) }} }">
                            ...
                            <div class="flex justify-between items-center mt-1">
                                ...
                                <p class="text-xs ml-auto flex-shrink-0 transition-colors" :class="count >= 45 ? 'text-amber-500 font-medium' : 'text-gray-400'" x-text="count + '/50'">0/50</p>
                            </div>
                        </div>
                        <div x-data="{ count: {{ mb_strlen(old('whatsapp', $kontak->whatsapp ?? '')) }} }">
                    ...
                    <div x-data="{ count: {{ mb_strlen(old('alamat', $kontak->alamat ?? '')) }} }">
                        <label for="alamat" class="form-label">Alamat</label>
                        <textarea id="alamat" name="alamat" rows="2" 
                                  class="form-input @error('alamat') border-red-500 @enderror"
                                  placeholder="Masukkan alamat lengkap"
                                  maxlength="500"
                                  x-on:input="count = $el.value.length">{{ old('alamat', $kontak->alamat) }}</textarea>
                        <div class="flex justify-between items-center mt-1">
                    ...
                    <div x-data="{ count: {{ mb_strlen(old('google_maps_embed', $kontak->google_maps_embed ?? '')) }} }">
                        ...
                        <input type="text" id="google_maps_embed" name="google_maps_embed" 
                               ...
                               x-on:input="count = $el.value.length">
                        <div class="flex justify-between items-center mt-1">
                            <p class="text-xs text-gray-400">Ambil dari Google Maps > Share > Embed a map > Copy src URL</p>
            ...
            <div class="bg-white rounded-xl border border-gray-200 shadow-sm overflow-hidden">
                ...
                <div class="p-5 space-y-4">
                    <div class="grid sm:grid-cols-2 gap-4">
                        <div x-data="{ count: {{ mb_strlen(old('facebook', $kontak->facebook ?? '')) }} }">
                            ...
                            <input type="text" id="facebook" name="facebook" 
                                   ...
                                   maxlength="255"
                                   x-on:input="count = $el.value.length">
                            <p class="text-xs mt-1 transition-colors" :class="count >= 230 ? 'text-amber-500 font-medium' : 'text-gray-400'" x-text="count + '/255'">0/255</p>
                        </div>
                        <div x-data="{ count: {{ mb_strlen(old('instagram', $kontak->instagram ?? '')) }} }">
                    ...
                    <div class="grid sm:grid-cols-2 gap-4">
                        <div x-data="{ count: {{ mb_strlen(old('youtube', $kontak->youtube ?? '')) }} }">
                        ...
                        <div x-data="{ count: {{ mb_strlen(old('tiktok', $kontak->tiktok ?? '')) }} }">
                    ...
                    <div class="grid sm:grid-cols-2 gap-4">
                        <div x-data="{ count: {{ mb_strlen(old('twitter', $kontak->twitter ?? '')) }} }">
