                ...
                <div class="space-y-5">
                    ...
                    <div>
                        ...
                        <textarea id="deskripsi" 
                                  ...
                                  placeholder="Deskripsi singkat tentang laporan ini (maks 1000 karakter)">{{ old('deskripsi', $laporanTahunan->deskripsi) }}</textarea>
                        @error('deskripsi')
                            <p class="form-error mt-1">{{ $message }}</p>
                        @enderror
                    </div>
                ...
                <div x-show="open" x-collapse class="mt-4 space-y-4">
                    ...
                    <div>
                        ...
                        <textarea id="meta_description" 
                                  ...
                                  maxlength="160">{{ old('meta_description', $laporanTahunan->meta_description) }}</textarea>
