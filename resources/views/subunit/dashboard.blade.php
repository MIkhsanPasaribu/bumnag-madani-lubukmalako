...
@section('page_title', 'Dashboard ' . $subUnit->nama)
...
<div class="space-y-6">
    ...
    <div class="bg-gradient-to-r from-primary to-primary-dark rounded-2xl p-6 text-white">
        ...
        <p class="text-white/80 mt-1">{{ $unit->nama }} — {{ $subUnit->nama }} — Tahun {{ $tahun }}</p>
    </div>
        ...
        <div class="overflow-x-auto">
            <table class="w-full text-sm">
                ...
                <tbody class="divide-y divide-gray-100">
                    ...
                    @empty
                        <tr><td colspan="4" class="px-4 py-8 text-center text-gray-500">Belum ada laporan.</td></tr>
                    @endforelse
                </tbody>
            </table>
        </div>
