...
@section('page-title', 'Profil BUMNag')

@section('content')
<div class="space-y-8">
    <div class="bento-card-accent">
        <div class="flex flex-col md:flex-row items-center gap-6">
            <img src="{{ asset('images/logo.png') }}" alt="Logo BUMNag" class="h-32 w-auto bg-white rounded-xl p-3">
            <div>
                <h1 class="text-2xl md:text-3xl font-bold mb-2">{{ $profil?->nama_bumnag ?? 'BUMNag Madani Lubuk Malako' }}</h1>
                <p class="text-white/90">Badan Usaha Milik Nagari</p>
                @if($profil?->tahun_berdiri)
                <p class="text-white/70 mt-2">Berdiri sejak {{ $profil->tahun_berdiri }}</p>
                @endif
            </div>
        </div>
    </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <div class="lg:col-span-2 space-y-6">
            <div class="bento-card">
                <h3 class="text-lg font-semibold text-bumnag-gray mb-4 flex items-center gap-2">
                    <svg class="w-5 h-5 text-bumnag-olive" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="bento-card border-l-4 border-bumnag-red">
                    <h3 class="text-lg font-semibold text-bumnag-gray mb-4 flex items-center gap-2">
                        <svg class="w-5 h-5 text-bumnag-red" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div class="space-y-6">
                ...
                <div class="space-y-4">
                    ...
                    <div class="flex gap-3">
                        ...
                        <div>
                            ...
                            <p class="text-sm text-gray-500">{{ $profil->alamat }}</p>
                        </div>
                    </div>
                    @endif
                    ...
                    <div class="flex gap-3">
                        ...
                        <div>
                            ...
                            <p class="text-sm text-gray-500">{{ $profil->telepon }}</p>
                        </div>
                    </div>
                    @endif
                    ...
                    <div class="flex gap-3">
                        ...
                        <div>
                            ...
                            <a href="{{ $profil->website }}" target="_blank" class="text-sm text-bumnag-olive hover:underline">{{ $profil->website }}</a>
                        </div>
                    </div>
                    @endif
                </div>
            ...
            <div class="bento-card-red">
                <h3 class="text-lg font-semibold mb-4">Transparansi Keuangan</h3>
                <p class="text-white/90 text-sm mb-4">Lihat laporan keuangan BUMNag secara transparan dan akuntabel.</p>
                <a href="{{ route('keuangan.transparansi') }}" class="inline-flex items-center gap-2 bg-white text-bumnag-red px-4 py-2 rounded-lg font-medium hover:bg-gray-100 transition">
